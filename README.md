...
| [legion](https://github.com/LegionIO/kai-plugin-legion) | v2.0.5 | Legion integration — daemon health, event streaming, proactive threads, workflow routing, knowledge panels, and daemon-powered LLM inference |
