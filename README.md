...
|--------|---------|-------------|
| [cron](https://github.com/LegionIO/kai-plugin-cron) | v0.1.11 | Schedule recurring tasks and reminders |
| [bluebubbles](https://github.com/LegionIO/kai-plugin-bluebubbles) | v0.2.13 | iMessage integration via BlueBubbles |
...
| [legion](https://github.com/LegionIO/kai-plugin-legion) | v2.0.2 | Legion integration — daemon health, event streaming, proactive threads, workflow routing, knowledge panels, and daemon-powered LLM inference |
