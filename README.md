...
| [visualizations](https://github.com/LegionIO/kai-plugin-visualizations) | v0.1.2 | AI-driven diagram & chart authoring. Generate and iterate on ERDs, architecture diagrams, flowcharts, and data charts through an agentic chat loop, rendered live with Mermaid and Chart.js. |
| [msgraph](https://github.com/LegionIO/kai-plugin-msgraph) | v0.5.5 | Microsoft Teams chat via Graph API — list, search, read, and send DMs and group chats with AI tooling |
